...
//set the color and shape of game board, snake, and fruit
    public void paint(Graphics g)
    {
        ...
        g.drawString("Score: " + score + "        Speed: " +
                speed + "      MaxSpeed 100 " , 250, 25);
...
//        退出程序
    ...
    public void keyPressed(KeyEvent e) {
        ...
        switch(e.getKeyCode()) {
//when the length of the snake is 1, it means the user can control the snake to
//every direction; when the length of the snake is greater than 1,
//it means the snake is moving, and it can't move in opposite direction
            case KeyEvent.VK_UP:
